...
#define RADAR_ADC_Pin GPIO_PIN_3
#define RADAR_ADC_GPIO_Port GPIOA
#define LED2_Pin GPIO_PIN_5
#define LED2_GPIO_Port GPIOA
#define LED3_Pin GPIO_PIN_6
#define LED3_GPIO_Port GPIOA
#define LED_Header_Pin GPIO_PIN_7
#define LED_Header_GPIO_Port GPIOA
#define BUTTON_PIN_Pin GPIO_PIN_0
#define BUTTON_PIN_GPIO_Port GPIOB
#define ENABLE_PIN_Pin GPIO_PIN_15
